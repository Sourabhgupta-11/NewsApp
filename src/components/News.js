...
export class News extends Component {
  ...
  */
  ...
  render() {
    return (
    <>
      <h2 className='text-center' style={{margin:"30px", color: this.props.mode==='dark'?'white':'black'}}>NewsApp - Top {this.capitalizeFirstLetter(this.props.category)} Headlines!</h2>
